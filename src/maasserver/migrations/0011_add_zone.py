...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'maasserver_zone', (
            ...
            ('node_group', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['maasserver.NodeGroup'], unique=True)),
            ('_serial_number', self.gf('django.db.models.fields.IntegerField')(default=-2147483648)),
        ))
    ...
    models = {
        ...
        u'maasserver.node': {
            ...
            'system_id': ('django.db.models.fields.CharField', [], {'default': "u'node-2cb3544a-c137-11e1-9f67-00219bd0a2de'", 'unique': 'True', 'max_length': '41'}),
        ...
        u'maasserver.zone': {
            ...
            '_serial_number': ('django.db.models.fields.IntegerField', [], {'default': '-2147483648'}),
            'created': ('django.db.models.fields.DateTimeField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'node_group': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['maasserver.NodeGroup']", 'unique': 'True'}),
            'updated': ('django.db.models.fields.DateTimeField', [], {})
        },
        'piston.consumer': {
        ...
        'piston.token': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'max_length': '18'}),
            'secret': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1340897851L'}),
