...
class Migration(DataMigration):
    ...
    def backwards(self, orm):
        for node in orm['maasserver.Node'].objects.all():
            # Drop subarch for backwards migration. This is lossy.
            node.architecture = node.architecture.split('/')[0]
            node.save()
    ...
    models = {
        ...
        u'maasserver.node': {
            ...
            'system_id': ('django.db.models.fields.CharField', [], {'default': "u'node-d0ef9648-070c-11e2-af1c-525400f6f496'", 'unique': 'True', 'max_length': '41'}),
        ...
        'piston.token': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'max_length': '18'}),
            'secret': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1348576239L'}),
