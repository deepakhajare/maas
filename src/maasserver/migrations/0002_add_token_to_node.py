...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Node.token'
        db.add_column('maasserver_node', 'token', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['piston.Token'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Node.token'
        db.delete_column('maasserver_node', 'token_id')
    ...
    models = {
        ...
        'maasserver.node': {
            ...
            'system_id': ('django.db.models.fields.CharField', [], {'default': "u'node-b2aa2496-7323-11e1-b1d8-0026c71eea0e'", 'unique': 'True', 'max_length': '41'}),
        ...
        'piston.token': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'max_length': '18'}),
            'secret': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1332313295L'}),
