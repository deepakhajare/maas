...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Node.architecture'
        db.alter_column(u'maasserver_node', 'architecture', self.gf('django.db.models.fields.CharField')(max_length=31))

    def backwards(self, orm):

        # Changing field 'Node.architecture'
        db.alter_column(u'maasserver_node', 'architecture', self.gf('django.db.models.fields.CharField')(max_length=10))
    ...
    models = {
        ...
        u'maasserver.node': {
            ...
            'architecture': ('django.db.models.fields.CharField', [], {'default': "u'i386'", 'max_length': '31'}),
            ...
            'system_id': ('django.db.models.fields.CharField', [], {'default': "u'node-b0c58d1c-07c2-11e2-990e-525400f6f496'", 'unique': 'True', 'max_length': '41'}),
        ...
        'piston.token': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'max_length': '18'}),
            'secret': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1348654354L'}),
