...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'metadataserver_nodecommissionresult', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 12, 11, 0, 0)),
                      keep_default=False)
    ...
    models = {
        ...
        u'maasserver.node': {
            ...
            'system_id': ('django.db.models.fields.CharField', [], {'default': "u'node-e433bb64-43b4-11e2-b069-3c970e0e56dc'", 'unique': 'True', 'max_length': '41'}),
        ...
        'piston.token': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'max_length': '18'}),
            'secret': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1355244629L'}),
